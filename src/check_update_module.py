...
def check_new_version(current_version):
    version_url = "https://raw.githubusercontent.com/JuanBindez/SpectroViz/main/version.json"
    ...
    try:
        ...
        if latest_version != current_version:
            message = f"SpectroViz {latest_version} Available!\n\n"
            ...
            ask = messagebox.askokcancel("SpectroViz", message + "\n\n\n\nwant to download the new version?")
            if ask == True:
                print(link)
